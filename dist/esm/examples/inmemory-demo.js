...
async function main() {
    ...
    const svc = new MessagingService(() => transport, { maxAttempts: 2, baseDelayMs: 100 }, {
    ...
    await svc.publish("test-topic", { hello: "fail" }, "demo-service", "corr-2", { contentType: ContentType.JSON });
